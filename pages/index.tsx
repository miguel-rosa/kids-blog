  ...
  return (
    <div className={styles.container}>
      <header className={styles.header}>
        <Image alt="Amigos do planeta" className={styles.logo} src="/amigos-do-planeta.png"/>
      </header>
      ...
      <main className={styles.main}>
        ...
        <Image alt="Planeta" src="/planeta-2.png"/>
        ...
        <Image alt="Pinguim" src="/pinguim.png"/>
        ...
        <Image alt="Planeta" src="/planeta-1.png"/>
        <ol type = "1">
        ...
        <Image alt="Protesto" src="/protesto.png"/> 
      </main>
    </div>
  )
}
