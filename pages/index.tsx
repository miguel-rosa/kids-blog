    ...
    <div className={styles.container}>
      ...
      <div className={styles.hero}>
        <h1 className={styles.title}>
          ...
          O que é, suas consequências e como reduzir o impacto ambiental
        </h1>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.videos}>
          <iframe src="https://player.vimeo.com/video/647457455" className={styles.video}/>
          <iframe src="https://player.vimeo.com/video/647512542" className={styles.video}/>
        </div>
      </main>
    </div>
  )
